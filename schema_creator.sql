...
insert into course (code, title, description, credit) values ("CS506","Data structure and algorithm","Data structure and Algorithms",4);
insert into course (code, title, description, credit) values ("CS509","PG Software Lab","PG Software Lab",4);
insert into course (code, title, description, credit) values ("CS526-f22","Mathematics Foundation of Computer Science","Mathematics Foundation of Computer Science",3);
insert into course (code, title, description, credit) values ("CS527","Computer Systems","Computer Systems",4);
insert into course (code, title, description, credit) values ("CS501","Data Science and Machine Learning","Data Science and Machine Learning",4);
insert into course (code, title, description, credit) values ("CS502","Reinforcement Learning","Reinforcement Learning",4);
insert into course (code, title, description, credit) values ("CS503","Internet of Things","Internet of Things",4);
insert into course (code, title, description, credit) values ("CS504","Digital Image Processing","Digital image processing",3);
insert into course (code, title, description, credit) values ("CS505","Spatial Computing","Spatial computing",4);
